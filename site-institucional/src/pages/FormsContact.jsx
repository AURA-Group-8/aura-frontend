function FormsContact(){
    ...
    return(
        <>
            <form action="#" method="post" className="flex flex-col text-[#FFF3DC] gap-2 text-xl md:text-2xl max-w-100 p-5">
                ...
                <button type="submit" className="bg-[#982546] border border-[#FFF3DC] rounded-xl cursor-pointer w-40 h-10 self-end ">Enviar</button>
            </form>
        </>
    )
