    ...
    return (
        ...
        <>
            ...
            <div className="h-screen w-full text-[#982546] bg-[#FFF3DC] flex flex-col justify-center items-center">
                ...
                <div className="flex flex-col w-120 md:w-full text-center xl:text-xl">
                ...
                <div className=" mt-5 border border-[#982546] border-t-8 h-60 w-120 md:w-120 xl:w-150 xl:text-xl p-5 flex  flex-col justify-center rounded-2xl">
