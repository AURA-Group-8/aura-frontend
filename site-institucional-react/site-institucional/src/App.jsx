...
function App() {
  ...
  return (
    <>
      ...
      <section className="bg-[#FFF3DC] bg-[url('src/assets/wave-background.png')] bg-center bg-cover h-140 w-full ">
        <Section_2/>
      </section>

      <section className="bg-[#FFF3DC] h-140 w-full ">
        <Section_3/>
      </section>

      <section className="bg-[#241313] h-140 w-full ">
        <Section_4/>
      </section>

      <section className="bg-[#1D0F0F] h-80 w-full ">
        <Footer/>
      </section>
