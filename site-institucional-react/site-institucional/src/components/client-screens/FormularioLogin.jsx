        ...
        <>
            <div className="flex items-center justify-center h-screen bg-[#FFF2DC] relative ">
                ...
                <div className="bg-[#982546] w-[40vw] rounded-xl p-8 flex flex-col items-center text-white shadow-lg font-bold z-10">
                    ...
                    <form className="w-full flex flex-col gap-[0.5vh] text-xs text-[#FFF2DC]" onSubmit={(e) => {
                        e.preventDefault();
                        navigate("/components/client-screens/Home-client");
                    }} >

                        <label htmlFor="Campo">Email:</label>
                        <input type="text" className="p-2 rounded-xl w-full bg-white text-black border border-[#341C1C] hover:border-[#FFF2DC] mb-4" required />

                        <label htmlFor="senha">Senha:</label>
                        <input type="password" className="p-2 rounded-xl w-full bg-white text-black border border-[#341C1C] hover:border-[#FFF2DC] mb-4" required />
